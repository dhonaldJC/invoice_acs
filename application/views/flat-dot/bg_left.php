<div id="sidebar-left" class="span1">
	<div class="nav-collapse sidebar-nav">
		<ul class="nav nav-tabs nav-stacked main-menu">
			...
			<li class="<?php echo $mark_jenis_service; ?>"><a href="<?php echo base_url(); ?>dashboard/jenis_service"><i class="fa-icon-calendar"></i><span class="hidden-tablet"> Jenis Service</span></a></li>
