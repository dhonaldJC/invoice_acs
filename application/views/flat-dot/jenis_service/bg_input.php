...
<div class="row-fluid sortable">		
	<div class="box span12">
		<div class="box-header" data-original-title="">
			...
			<i class="halflings-icon plus-sign"></i><a href="<?php echo base_url(); ?>dashboard/jenis_service/tambah">Tambah Data</a><span class="break"></span>
			Jenis Service</h2>
		</div>
		<div class="box-content">
			<?php echo form_open("dashboard/jenis_service/simpan",'class="form-horizontal"'); ?>
			  <fieldset>
			  
				<div class="control-group">
				  <label class="control-label">Nama Service</label>
				  <div class="controls">
					<input type="text" class="input-xlarge" value="<?php echo $nama_service; ?>" name="nama_service" required />
				  </div>
				</div>
