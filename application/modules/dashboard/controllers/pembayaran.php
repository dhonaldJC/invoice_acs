...
class pembayaran extends CI_Controller {
	...
	function edit($id_param,$id_pemesanan)
	{
		if($this->session->userdata("logged_in")!="")
		{
			...
			$get_detail = $this->db->query("select a.kode_jenis_service, a.jumlah, b.harga, b.nama_cetakan, b.satuan from dlmbg_pemesanan_detail a left join 
			(select x.nama_cetakan, y.satuan,  x.harga, x.kode_jenis_service from dlmbg_jenis_service x left join dlmbg_jenis_satuan y on x.id_jenis_satuan=y.id_jenis_satuan) 
			b on a.kode_jenis_service=b.kode_jenis_service where a.kode_pemesanan='".$id_pemesanan."'");
